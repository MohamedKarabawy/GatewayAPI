...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    //Branches
    Route::get('/v1/dashboard/view-branches', [BranchesController::class, 'viewBranches']);
    ...
    Route::put('/v1/dashboard/waitlist/times', [WaitlistController::class, 'viewTimes']);
    ...
    //Batches
    Route::put('/v1/dashboard/batches/{batch_id}/filter-classes', [BatchesController::class, 'filterClasses']);
